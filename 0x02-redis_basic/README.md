# Redis basic
This project contains tasks that illustrate how to use redis for basic operations and as a simple cache.
...
## License
All the code in this project is under the [MIT License](/LICENSE)